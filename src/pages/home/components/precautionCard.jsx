        ...
        <div className="row py-5">
          <div className="col-md-6 order-3 order-md-1">
            ...
            <div className="para my-4">
              Our citizen's health is our responsibility. Precaution Dose is available for fully vaccinated HCW/FLW and
              Senior Citizens (60+ yrs) after 39 weeks from 2nd dose. Citizens aged 60 years or more and having
              co-morbidities, should take precaution dose, only after medical advice. Both online and walk-in available.
            </div>
            <Link to="appointmentDetails">
              <button className="r-btn btn-md">Book Your Slot</button>
            </Link>
          </div>
          <div className="order-2 d-none d-md-block" style={{ width: "40px" }}></div>
