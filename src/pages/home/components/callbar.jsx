...
function Callbar() {
  return (
    <div className="callbar">
      <div className="row">
        <div className="col-2 d-none d-md-block support-col my-auto">
        ...
        <div className="col">
          <div className="row title-row">
            ...
            <div className="col d-none d-sm-block"> Mental Health </div>
            <div className="col"> Senior Citizen </div>
            <div className="col d-none d-sm-block"> NCW </div>
          </div>
          <div className="row">
            <div className="col">
              <div>
                <a href="tel:+911123978046">91-11-2397 8046</a>
