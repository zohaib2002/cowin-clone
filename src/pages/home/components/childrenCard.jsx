        ...
        <div className="row py-5">
          ...
          <div className="col-md-6">
            ...
            <div className="para my-4">
              Protect your child! Getting your children(15-18 yrs) vaccinated is the best thing you can do to protect
              them from COVID-19. Vaccination slots can now be booked for children aged 15-18 yrs. Both online and
              walk-in available.
            </div>
